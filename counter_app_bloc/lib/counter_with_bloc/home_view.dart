import 'package:counter_app_bloc/counter_with_bloc/detail_view.dart';
...
class HomeViewBloc extends StatefulWidget {
  ...
  @override
  State<HomeViewBloc> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<HomeViewBloc> {
  @override
  Widget build(BuildContext context) {
    print(' Bloc new Build Metod');
    return Scaffold(
      appBar: AppBar(
