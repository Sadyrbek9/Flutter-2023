...
class MeninWidgetim extends StatefulWidget {
  ...
  @override
  State<MeninWidgetim> createState() => _MeninWidgetim();
}

class _MeninWidgetim extends State<MeninWidgetim> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: const [Icon(Icons.search), Icon(Icons.access_alarm)],
      ),
      body: Column(
        children: const [
          Text('data'), 
        ...
        child: ListView.builder(
          ...
          itemBuilder:(BuildContext context, int index){
            return ListTile(
              ...
              title: const Text("Bilim Jawtary"),
          ...
          BottomNavigationBarItem(icon: Icon(Icons.access_time), label: "Business"),
