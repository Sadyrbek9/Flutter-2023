...
import 'package:sabak2_counter_app_ekinchibet/secondPage.dart';
      ...
      body: Padding(
       ...
       child: Center(
         ...
         Container(
          ...
          height: 30,
            decoration:BoxDecoration(color: const Color.fromARGB(255, 131, 212, 172), borderRadius: BorderRadius.circular(8),
            ),
