...
class _HomePageState extends State<HomePage> {
  ...
  UseQuize useQuize = UseQuize(); // бул классты, UseFile папкадан тартып келдик, эми колдонобуз
 
  List<Icon> iconAluu = []; // icon келечекте келет
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                width: 335,
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(backgroundColor: AppColors.falseBgrColor
                   ),
                   onPressed: () {
                    teksher(false);
                   },
